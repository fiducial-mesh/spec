...
| `dpg.*` | DPG-specific — code emission carries `(emitting_principal_id, emitting_session_id, code_hash, target_pillar)`; execution complete carries `(code_hash, exit_code, resource_usage_summary)`. |
